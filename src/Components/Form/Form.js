  ...
  return (
    <FormStyled onSubmit={handleSubmit}>
        ...
        <div className='input-control'>
            ...
            <div className='input-control'>
            <textarea name='description' value={description} placeholder='Ajouter une description' id="description" cols='30' rows="4"onChange={handleInput('description')}></textarea>
            </div>
